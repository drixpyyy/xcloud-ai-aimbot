...
**Bug fixes**: if it doesnt use webgpu then its not using ur gpu or integrated gpu so go to chrome://flags search up webgpu and enable unsafe webgpu support and webgpu developer features but if u dont neeed them thats perfectly fine
